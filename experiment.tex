...
The experiment involves two GPUs to measure the performance of training multiple datasets under four GNNs, including time overhead, GPU utilization and peak memory consumption.
