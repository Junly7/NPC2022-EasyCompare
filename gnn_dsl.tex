...
The primary functional interfaces of GUC include graph convolutions and activation functions. In addition, GUC also involves other interfaces to implement network definition and batch training (e.g., tensor, dropout, and linear).
