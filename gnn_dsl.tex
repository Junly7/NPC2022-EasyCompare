...
class NET {
  ...
  \end{lstlisting}
  \caption{\textcolor{blue}{GCN implementation in GUC.}}
  \label{fig:gcn_guc}
\end{figure}
...
\subsubsection{Mini-batch} \textcolor{blue}{GUC supports mini-batch training with batch sizes. According to the batch size defined by users and fixed settings, datasets will be automatically batched with \textsl{NeighborSampler}~\cite{hamilton2017inductive}.}
