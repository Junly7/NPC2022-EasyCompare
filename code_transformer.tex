...
class NET(nn.Module):
  def __init__(self,in_feat,out_feat):
    super().__init__()
    self.conv1=GCNConv(in_feat,16,bias=True,normalize=False)
...
class NET(nn.Module):
  def __init__(self,in_feat,out_feat):
    super().__init__()
    self.conv1=GraphConv(in_feat,16,bias=True,norm='none')
    self.conv2=GraphConv(16,out_feat,bias=False,norm='both')
    self.relu1=nn.ReLU()
    self.relu2=nn.LeakyReLU(0.5)
