...
\subsection{Local and remote different GPU resource scheduling}
...
\begin{figure}
    ...
    \caption{state transformation and flow process of running tasks on remote GPU server}
...
\textbf{GUC to model code transform and automated deployment training:}
...
\begin{figure}[!h]
    ...
    \begin{minipage}[c]{0.47\textwidth}
        ...
        \label{fig:same_op_compare}
    \end{minipage}
    \caption{\centering result comparison}
    \label{fig:result_comparison}
\end{figure}
