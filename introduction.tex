...
Based on EasyCompare, we conduct extensive experiment to explore the factors that influence the performance of GNN models. \textcolor{blue}{The results show that... (brief description)}

\textcolor{blue}{The rest of this paper is orgnized as follows ... (paper organization)}
